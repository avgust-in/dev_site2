...
= 2.5.16 =
* Reverted wp_safe_redirect to wp_redirect, as wp_safe_redirect causes a redirect to 123.php even when the primary url is domain.com and request url www.domain.com
